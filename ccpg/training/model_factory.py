...
from ccpg.ccsa import (
    CategoryCentricSemanticAggregation,
    CategorySemanticProjection,
)
from ccpg.feature_extraction import (
    DomainSpecificSpectralMapping,
    SpectralSpatialFeatureEncoder,
)
from ccpg.prototype_refinement import PrototypeRefinementNetwork


@dataclass
class CCPGModelBundle:
